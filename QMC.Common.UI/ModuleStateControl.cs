...
namespace QMC.Common.UI
{
    ...
    {
        private Font m_font = new Font("돋움", 11f, FontStyle.Bold);

        private Font m_ServiceFont = new Font("돋움", 11f, FontStyle.Bold);
        ...
        public ModuleStateControl(Module module)
        {
            ...
            this.flowLayoutPanelButton.Size = new Size(baseGroupBoxPartInit.Size.Width - Configuration.ControlGap_2, baseGroupBoxPartInit.Size.Height - Configuration.ControlGap_3);
            this.flowLayoutPanelButton.FlowDirection = FlowDirection.TopDown;
            //this.flowLayoutPanelButton.BackColor = Color.Red;
            this.flowLayoutPanelButton.Location = new Point(groupBoxStateControl.Location.X + Configuration.ControlGap + 1, groupBoxStateControl.Location.Y + Configuration.ControlGap_2);
