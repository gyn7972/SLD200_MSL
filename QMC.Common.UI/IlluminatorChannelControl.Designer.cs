namespace QMC.Common.UI
{
    partial class IlluminatorChannelControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.baseGroupBoxIlluminator = new BaseGroupBox();
            this.baseButtonClear = new BaseButton();
            this.baseButtonRemove = new BaseButton();
            this.baseButtonAdd = new BaseButton();
            this.baseDataGridViewIlluminator = new BaseDataGridView();
