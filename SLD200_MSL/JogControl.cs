...
namespace SLD200_MSL
{
    ...
    public partial class JogControl : UserControl
    {
        ...
        AxisYRevision m_AxisYRevision2;
        //JogButtonCombinationUVW m_JogButtonCombination_UVW;
        JogButtonCombinationXY m_JogButtonCombination_XY;
        JogButtonCombinationXZ m_JogButtonCombination_XZ_LD;
        JogButtonCombinationXZ m_JogButtonCombination_XZ_UL;
        ...
        public JogControl(Part part)
        {
            ...
            m_JogButtonCombination_XZ_LD = new JogButtonCombinationXZ();
            m_JogButtonCombination_XZ_UL = new JogButtonCombinationXZ();
            ...
            //this.flowLayoutPanelJogButtonComb_XZ_LD.Location = new Point(this.radioButtonContinuous.Location.X, this.radioButtonContinuous.Location.Y + this.radioButtonContinuous.Height + 6);
            ////this.flowLayoutPanelJogButtonComb_XZ_UL.Location = new Point(this.radioButtonContinuous.Location.X, this.radioButtonContinuous.Location.Y + this.radioButtonContinuous.Height + 6);
            ...
            ////}
            //if (this.flowLayoutPanelJogButtonComb_XZ_LD.Controls.Count == 0)
            //{
            ...
            if (part == unloader.Stage)
            {
                //  Stacker Z0, Stacker Z1, Transfer X-Z 
                this.flowLayoutPanelJogButtonComb_XZ_UL.Visible = true;
                this.flowLayoutPanelJogButtonComb_XZ_UL.Size = new Size(this.m_JogButtonCombination_XZ_UL.Size.Width, this.m_JogButtonCombination_XZ_UL.Size.Height);
                this.flowLayoutPanelJogButtonComb_XZ_UL.Location = new Point(this.radioButtonContinuous.Location.X, this.radioButtonContinuous.Location.Y + this.radioButtonContinuous.Size.Height + 20);
            }
            else if (part == workStage.Stage)
            {
                //  Scanner X-Y
                this.flowLayoutPanelJogButtonComb_XY.Visible = true;
                this.flowLayoutPanelJogButtonComb_XY.Size = new Size(this.m_JogButtonCombination_XY.Size.Width, this.m_JogButtonCombination_XY.Size.Height);
                this.flowLayoutPanelJogButtonComb_XY.Location = new Point(this.radioButtonContinuous.Location.X, this.radioButtonContinuous.Location.Y + this.radioButtonContinuous.Size.Height + 20);

                //  Scanner Z
                this.flowLayoutPanelJogButtonAxisY.Visible = true;
                this.flowLayoutPanelJogButtonAxisY.Size = new Size(this.m_AxisYRevision.Size.Width, this.m_AxisYRevision.Size.Height);
                this.flowLayoutPanelJogButtonAxisY.Location = new Point(this.flowLayoutPanelJogButtonComb_XY.Location.X + this.flowLayoutPanelJogButtonComb_XY.Width + 40, this.flowLayoutPanelJogButtonComb_XY.Location.Y);
                
                //  Mask Y
                this.flowLayoutPanelJogButtonAxisY2.Visible = true;
                this.flowLayoutPanelJogButtonAxisY2.Size = new Size(this.m_AxisYRevision.Size.Width, this.m_AxisYRevision.Size.Height); 
                this.flowLayoutPanelJogButtonAxisY2.Location = new Point(this.flowLayoutPanelJogButtonAxisY.Location.X + this.flowLayoutPanelJogButtonAxisY.Width + 30, this.flowLayoutPanelJogButtonAxisY.Location.Y);
            }
            else if (part == loader.Stage)
            {
                //  Aligner X, Aligner Y
                ...
                //  Stacker Z0, Stacker Z1, Transfer X-Z
                this.flowLayoutPanelJogButtonComb_XZ_LD.Visible = true;
                this.flowLayoutPanelJogButtonComb_XZ_LD.Size = new Size(this.m_JogButtonCombination_XZ_LD.Size.Width, this.m_JogButtonCombination_XZ_LD.Size.Height);
                this.flowLayoutPanelJogButtonComb_XZ_LD.Location = new Point(this.flowLayoutPanelJogButtonComb_XY.Location.X + this.flowLayoutPanelJogButtonComb_XY.Width + 40, this.flowLayoutPanelJogButtonComb_XY.Location.Y);
            }
        ...
        private void InitdataGridViewParameterColumns()
        {
            ...
            DataGridViewColumn column0 = dataGridViewJogControl.Columns[0];
            column0.Width = 120;
         }
        #endregion
        ...
        private void daragridview_buttonCellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridViewJogControl.SelectedCells[0].RowIndex >= 0)
            {
                ...
                if (m_nindex >= 0)
                {
                    ...
                    {
                        //ax.MovePosition(0);
                        //MC_Func.MC_MovePosition(workStage.workStageParameter.stWorkStagePosParam.nAxis[(int)WorkStage.nAxis.IZ], 
                        //                        ax.Velocity, ax.Configuration.Velocity, ax.Configuration.Acceleration, ax.Configuration.Deceleration);
                        //MC_Func.MC_MovePosition((int)WorkStageParameter.AxisAjinEnum.EZ,
                        //                        ax.Velocity, ax.Configuration.Velocity, ax.Configuration.Acceleration, ax.Configuration.Deceleration);
                    }
                }
            }
        ...
        public void AddJogButton()
        {
            ...
            flowLayoutPanelJogButtonAxisY2.Controls.Clear();
            ...
            flowLayoutPanelJogButtonComb_XZ_LD.Controls.Clear();
            flowLayoutPanelJogButtonComb_XZ_UL.Controls.Clear();
            ...
            foreach (MotionAxis axe in m_axis)
            {
                ...
                else if (axe.Configuration.DisplayAxisType == DisplayAxisType.Vertical2)
                {
                    m_AxisYRevision2 = new AxisYRevision();
                    m_AxisYRevision2.Location = new Point(0, 0);
                    m_AxisYRevision2.AxisValue = axe;
                    m_AxisYRevision2.AxisList.Add(axe);
                    m_AxisYRevision2.SetButtonName(axe.Name);
                    flowLayoutPanelJogButtonAxisY2.Controls.Add(m_AxisYRevision2);
                    m_AxisYRevision2.JogButtonClick += JogbuttonEvent;
                    m_AxisYRevision2.JogButtonDown += JogbuttonDownEvent;
                    m_AxisYRevision2.JogButtonUp += JogbuttonUpEvent;
                }
                ...
                else if (axe.Configuration.DisplayAxisType == DisplayAxisType.CombinationPicker)
                {
                    if (m_Part == loader.Stage)
                    {
                        if (m_JogButtonCombination_XZ_LD.Z0Axis == null)
                        {
                            m_JogButtonCombination_XZ_LD.Z0Axis = axe;
                            m_JogButtonCombination_XZ_LD.AxisList.Add(axe);
                        }
                        else if (m_JogButtonCombination_XZ_LD.Z1Axis == null)
                        {
                            m_JogButtonCombination_XZ_LD.Z1Axis = axe;
                            m_JogButtonCombination_XZ_LD.AxisList.Add(axe);
                        }
                        else if (m_JogButtonCombination_XZ_LD.HorizontalAxis == null)
                        {
                            m_JogButtonCombination_XZ_LD.HorizontalAxis = axe;
                            m_JogButtonCombination_XZ_LD.AxisList.Add(axe);
                        }
                        else
                        {
                            m_JogButtonCombination_XZ_LD.VerticalAxis = axe;
                            m_JogButtonCombination_XZ_LD.AxisList.Add(axe);
                        }
                    }
                    else if (m_Part == unloader.Stage)
                    {
                        if (m_JogButtonCombination_XZ_UL.Z0Axis == null)
                        {
                            m_JogButtonCombination_XZ_UL.Z0Axis = axe;
                            m_JogButtonCombination_XZ_UL.AxisList.Add(axe);
                        }
                        else if (m_JogButtonCombination_XZ_UL.Z1Axis == null)
                        {
                            m_JogButtonCombination_XZ_UL.Z1Axis = axe;
                            m_JogButtonCombination_XZ_UL.AxisList.Add(axe);
                        }
                        else if (m_JogButtonCombination_XZ_UL.HorizontalAxis == null)
                        {
                            m_JogButtonCombination_XZ_UL.HorizontalAxis = axe;
                            m_JogButtonCombination_XZ_UL.AxisList.Add(axe);
                        }
                        else
                        {
                            m_JogButtonCombination_XZ_UL.VerticalAxis = axe;
                            m_JogButtonCombination_XZ_UL.AxisList.Add(axe);
                        }
                    }
                }
            ...
            {
                flowLayoutPanelJogButtonComb_XY.Visible = true;
                flowLayoutPanelJogButtonComb_XY.Controls.Add(m_JogButtonCombination_XY);

                if (m_Part == loader.Stage)
                {
                    m_JogButtonCombination_XY.baseLabelJogButtonComb_Title.Text = "Align";
                }
                else if (m_Part == workStage.Stage)
                {
                    m_JogButtonCombination_XY.baseLabelJogButtonComb_Title.Text = "Stage";
                }
            }

            if (flowLayoutPanelJogButtonComb_XZ_LD.Controls != null)
            {
            ...
            if (flowLayoutPanelJogButtonComb_XZ_UL.Controls != null)
            {
            ...
            if (m_axis != null)
            {
                for (int i = 0; i < m_axis.Count; i++)
                {
                    ...
                    if (m_axis[i] != null)
                    {
                        ...
                        {
                            //if (ACSSPiiPlusMotionBoard.Api.IsConnected && workStage.ACS_Motion_isSimulationMode)
                            //{
