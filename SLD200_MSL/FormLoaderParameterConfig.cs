...
{
    //  2022. 03. 25.  SCH : Configuration --> Module --> Loader 가 여기로 오는군... 
    public partial class FormLoaderParameterConfig : FormSubContentBase
    {
        //private VisionParameter m_Owner;
        ...
        public FormLoaderParameterConfig(Module module)
            : base(FormType.Content.ToString(), module.Name)
        {
            ...
            UpdateDataGridViewVisionPosition();
            SetGridConfigData(module);
        ...
        private void UpdateDataGridViewVisionPosition()
        {
            ...
            {
                DataGridViewColumn column = new DataGridViewTextBoxColumn();
                column.DataPropertyName = "Aligner X";
                column.Name = "Aligner X [mm]";
                LaserPositionGrid.Columns.Add(column);
            }
            {
                DataGridViewColumn column = new DataGridViewTextBoxColumn();
                column.DataPropertyName = "Aligner Y";
                column.Name = "Aligner Y [mm]";
                LaserPositionGrid.Columns.Add(column);
            }
        ...
        private void LaserPositionGrid_SelectionChanged(object sender, EventArgs e)
        {
            if (LaserPositionGrid.SelectedCells.Count > 0)
            {
                ...
                if (loader != null && nIndex >= 0)
                {
                    ...
                    //XyzyPositionData data = vision.Config.ParamConfig.VisionPositions[nIndex];
                    ZzxzxyPositionData data = loader.Config.ParamConfig.LoaderPositions[nIndex];
        ...
        public void SetGridConfigData(Module module)
        {
            ...
            LaserPositionGrid.DataSource = loader.Config.ParamConfig.LoaderPositions;
            LaserParameterGrid.SelectedObject = loader.loaderParameter.Config ;
        }
