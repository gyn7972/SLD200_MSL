...
namespace QMC.Vision
{
    public class InspectionProcessor : Module
    {
        ...
        public override int Create()
        {
            ...
            this.Stage = new XyzLDzzxzULzzxzStage("Stage");
            this.Stage.Create();
            ...
            this.VisionCalibrator.XyzLDzzxzULzzxzStage = this.Stage;
        ...
        public override void SetConfigData(object parameter)
        {
            ...
            if (Config.CameraType == CameraType.GrablinkCamera)
            {
                ...
                {
                    this.Config.CameraConfig = Camera.CameraConfig;
                }
            }
            else if(Config.CameraType == CameraType.HikCamera)
            {
                ...
                {
                    Camera.CameraConfig = this.Config.CameraConfig;
                }
                else
                {
                    this.Config.CameraConfig= Camera.CameraConfig;
