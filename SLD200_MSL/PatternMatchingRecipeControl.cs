    ...
    public partial class PatternMatchingRecipeControl : UserControl
    {
        ...
        protected virtual void SetPart(Part part)
        {
            ...
            if(module is WorkStage)
            {
                ...
                {
                    Parameters = ((WorkStage)module).Recipe.VisionCalibratorRecipe_HighRes.PatternMatchingParameters;
                    m_Recipe = ((WorkStage)module).Recipe.VisionCalibratorRecipe_HighRes;
                }
            }
