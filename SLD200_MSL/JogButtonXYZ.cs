...
{
    public partial class JogButtonXYZ : UserControl
    {
        ...
        public JogButtonXYZ()
        {
            ...
            this.baseLabelZ.TextAlign = ContentAlignment.MiddleCenter;
            ...
            this.baseLabelZ.Font = new Font(baseLabelX.Font.FontFamily, 9);
        }
        ...
        private void buttonAxisZUp_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
        ...
        private void buttonAxisZUp_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
        ...
        private void buttonAxisZDown_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
        ...
        private void buttonAxisZDown_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
