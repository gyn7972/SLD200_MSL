...
namespace SLD200_MSL
{
    public partial class SingleMode_CWA150SA : UserControl
    {
        ...
        public SingleMode_CWA150SA()
        {
            ...
            timer_SingleMode_DIO_Status.Interval = 1;
            ...
            //workStage.workStageParameter.DO_LaserWater_In(true);
            //workStage.workStageParameter.DO_LaserWater_Out(false);
            //workStage.workStageParameter.DO_ScannerWater_In(true);
            //workStage.workStageParameter.DO_ScannerWater_Out(false);
        ...
        private void timer_SingleMode_DIO_Status_Tick(object sender, EventArgs e)
        {
            ...
            timer_SingleMode_DIO_Status.Enabled = false;
        ...
        private void SingleModeUI_DIO_Status()
        {
            ...
            //if (!workStage.workStageParameter.IsDO_LaserWater_In() || !workStage.workStageParameter.IsDO_ScannerWater_In() ||
            //    workStage.workStageParameter.IsDO_LaserWater_Out() || workStage.workStageParameter.IsDO_ScannerWater_Out())
            //{
            //    if (workStage.m_bLaser_Emission)
            //    {
            //        workStage.SpectraPhysicsLaserComm_Laser_On(false);
            ...
            //baseLabel_ExitPosPower.Text = String.Format("{0:F3}", workStage.m_dPowerMeter_ExitPos_Value);
            //baseLabel_TargetPosPower.Text = String.Format("{0:F3}", workStage.m_dPowerMeter_TargetPos_Value);
            ...
            //    pictureBoxChillerStatus.Image = global::SLD200.Properties.Resources.StopOn;
            //else
            //    pictureBoxChillerStatus.Image = global::SLD200.Properties.Resources.StopOff;
            ...
            //    pictureBoxDoorUnlock.Image = global::SLD200.Properties.Resources.DioRectangleOn;
            //else
            //    pictureBoxDoorUnlock.Image = global::SLD200.Properties.Resources.DioRectangleOff;
        }
        ...
        private void lblWorkStage_Vacuum0_Status_Click(object sender, EventArgs e)
        {
            ...
            //if (workStage.workStageParameter.IsDO_Stage_Vacuum( 0 ))
            //    workStage.workStageParameter.DO_Stage_Vacuum(0, false);
            //else
            //    workStage.workStageParameter.DO_Stage_Vacuum(0, true);
        }
        ...
        {
            //workStage.workStageParameter.stWorkStagePosParam = workStage.workStageParameter.GetPositionInformation("Load");
            ...
            workStage.m_nHomeStep = (int)Home_Step.Start;
