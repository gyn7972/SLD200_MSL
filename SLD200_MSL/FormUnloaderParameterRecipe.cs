...
{
    public partial class FormUnloaderParameterRecipe : FormSubContentBase
    {
        ...
        public FormUnloaderParameterRecipe(Unloader unloader)
            : base(FormType.Content.ToString(), unloader.Name)
        {
            InitializeComponent();
            m_Owner = unloader;
