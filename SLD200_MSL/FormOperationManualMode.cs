...
namespace SLD200_MSL
{
    public partial class FormOperationManualMode : FormSubContentBase
    {
        ...
        //private bool m_bSelected_HighResCamera = true;            //  workStage class 에 선언
            ...
            :base(FormType.withButton.ToString(),"Manual Mode")
        {
            ...
            ManualMode_SLD200 manualMode_CWA150SA = new ManualMode_SLD200();
