...
namespace SLD200_MSL
{
    ...
    {
        public Size m_imagesize = new Size(25, 25);
            ...
            : base(FormType.Maint.ToString(), " IO List")
        {
            ...
            this.Font = new System.Drawing.Font("Tahoma", 9.75F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
        ...
        public void ShowDataGridView()
        {
            ...
            for (int i = 0; i < DioPointCollection.Count; i++)
            {
                ...
                {
                    Image img = SLD200.Properties.Resources.DioEllipseOff;
                ...
                {
                    Image img = SLD200.Properties.Resources.DioRectangleOff;
                    Bitmap imgbitmap = new Bitmap(img);
                    img = resizeImage(imgbitmap, m_imagesize);
                    DataGridViewImageCell cell = baseDataGridViewIO.Rows[i].Cells[m_Index] as DataGridViewImageCell;
                    cell.Value = img;
            ...
            for (int i = 0; i < baseDataGridViewIO.Rows.Count; i++)
            {
                ...
                if (dioPoint.IoType == IoType.Input)
                {
                    if (dioPoint.GetValue() == DioValue.On)
                    {
                        ...
                        Image img = SLD200.Properties.Resources.DioEllipseOn;
                        Bitmap imgbitmap = new Bitmap(img);
                        img = resizeImage(imgbitmap, m_imagesize);
                ...
                else
                {
                    if (dioPoint.GetValue() == DioValue.On)
                    {
                        ...
                        Image img = SLD200.Properties.Resources.DioRectangleOn;
                        Bitmap imgbitmap = new Bitmap(img);
                        img = resizeImage(imgbitmap, m_imagesize);
                        baseDataGridViewIO.Rows[i].Cells[0].Value = img;
                    }
