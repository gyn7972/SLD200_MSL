...
namespace SLD200_MSL
{
    public partial class FormJigAlignerMaint : FormSubContentBase
    {
        ...
        //private BaseButton m_LoadImage;
            ...
            : base(FormType.Maint.ToString(), part.Name)
        {
            ...
            //this.m_JogControl = new JogControl(m_Owner.workStageParameter);
            //this.m_JogControl = new JogControl(m_Owner.Stage);
            this.m_JogControl = new JogControl(workStage.Stage);
            ...
            //this.m_LoadImage = new BaseButton();
            ...
            this.m_TestFindFiducial.BackColor = Color.White;
            this.m_TestFindFiducial.ForeColor = Color.Black;
            this.m_TestFindFiducial.FlatAppearance.BorderColor = Color.Aqua;
            this.m_TestFindFiducial.FlatAppearance.BorderSize = 1;
            ...
            this.m_CameraInit.Font = new System.Drawing.Font("Tahoma", 10.0F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
            this.m_CameraInit.Text = "Cam Init.";
            this.m_CameraInit.BackColor = Color.White;
            this.m_CameraInit.ForeColor = Color.Black;
            this.m_CameraInit.FlatAppearance.BorderColor = Color.Aqua;
            this.m_CameraInit.FlatAppearance.BorderSize = 1;
            ...
            this.m_LiveStart.Font = new System.Drawing.Font("Tahoma", 10.0F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
            this.m_LiveStart.Text = "Live Start";
            this.m_LiveStart.BackColor = Color.White;
            this.m_LiveStart.ForeColor = Color.Black;
            this.m_LiveStart.FlatAppearance.BorderColor = Color.Aqua;
            this.m_LiveStart.FlatAppearance.BorderSize = 1;
            this.m_LiveStart.Click += M_LiveStart_Click;
            this.Controls.Add(this.m_LiveStart);

            //this.m_LoadImage = new BaseButton();
            //this.m_LoadImage.Location = new Point(this.m_LiveStart.Location.X, this.m_LiveStart.Location.Y + m_LiveStart.Height + Configuration.ControlGap);
            //this.m_LoadImage.Size = new Size(120, 50);
            //this.m_LoadImage.Font = new System.Drawing.Font("Tahoma", 12.0F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(129)));
            //this.m_LoadImage.Text = "Load Image";
            //this.m_LoadImage.Click += M_LoadImage_Click;
            //this.Controls.Add(this.m_LoadImage);
        ...
        //private void M_LoadImage_Click(object sender, EventArgs e)
        //{
        //    //  이미지 불러오기

        //    string m_strFile = "";

        //    if (m_Owner.Name == "JigAligner Lower")
        //    {
        ...
        //        {
        //            m_Owner.Camera.StopLive();

        //            m_strFile = dialog.FileName;

        //            m_visionImageViewer_Upper.Image = new Bitmap(m_strFile);
        //        }
        ...
        private void TrainButtonClick(TrainImageControl.ButtonType type)
        {
            ...
            else if (m_Owner.Name == "ReticleAligner Upper")
            {
                m_strFile = string.Format("{0}\\Reticle_Upper.jpg", ConfigManager.GetPatternImagePath());
                m_Owner.TrainImage.Save(m_strFile, QMC.Common.Vision.VisionImage.FileFilter.jpg);
            ...
            else if (m_Owner.Name == "ReticleAligner Lower")
            {
                m_strFile = string.Format("{0}\\Reticle_Lower.jpg", ConfigManager.GetPatternImagePath());
                m_Owner.TrainImage.Save(m_strFile, QMC.Common.Vision.VisionImage.FileFilter.jpg);
