...
{
    //  2022. 03. 25.  SCH : Configuration --> Module --> Vision 이 여기로 오는군... 
    public partial class FormVisionParameterConfig : FormSubContentBase
    {
        ...
        public FormVisionParameterConfig(Module module)
        ...
        {
            Vision vision = m_Module as Vision;
        ...
        {
            Vision vision = module as Vision;

            //LaserPositionGrid.DataSource = workStage.Config.Positions;
            LaserPositionGrid.DataSource = vision.Config.ParamConfig.VisionPositions;
            LaserParameterGrid.SelectedObject = vision.visionParameter.Config ;
        }
        ...
        private void buttonSave_Click(object sender, EventArgs e)
        {
            ...
            vision.m_bParameterSetting_PosData_Reload = true;
