...
{
    public partial class SMEMA_PRE : UserControl
    {
        private Font m_font = new Font("Tahoma", 12f, FontStyle.Bold);
        ...
        public SMEMA_PRE()
        {
            ...
            //this.Size = this.Size;  //  Configuration.ModuleStateControlSize;
        ...
        private void labelMachineReadyPRE_Click(object sender, EventArgs e)
        {
