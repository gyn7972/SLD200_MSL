...
namespace SLD200_MSL
{
    public partial class FormVisionCalibratorMaint : FormSubContentBase
    {
            ...
            : base(FormType.Maint.ToString(), part.Name)
        {
            ...
            this.m_JogControl = new JogControl(m_Owner.XyzLDzzxzULzzxzStage);
        ...
        private void M_OpenButton_Click(object sender, EventArgs e)
        {
            ...
            if (m_Owner.XyzLDzzxzULzzxzStage == null)
            {
                return;
            }
        ...
        private void PositionControlButtonClick(ModulePositionControl.ButtonType type)
        {
            if (type == ModulePositionControl.ButtonType.Save)
            {
                ...
                XyzLDzzxzULzzxzCoordinate coordinate = new XyzLDzzxzULzzxzCoordinate();// = m_Owner.GetCurrentPosition();

                m_Owner.XyzLDzzxzULzzxzStage.GetCommandPosition(ref coordinate);
            ...
            else if (type == ModulePositionControl.ButtonType.Move)
            {
                ...
                XyzLDzzxzULzzxzCoordinate coordinate = m_Owner.Config.GetCalibratorPosition(strPosition, TargetType.Base);

                Task<int> result = m_Owner.XyzLDzzxzULzzxzStage.BeginMovePosition(coordinate); // 참고: 무빙, 프로그래스 바 연동
