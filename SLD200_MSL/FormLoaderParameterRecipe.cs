...
{
    public partial class FormVisionParameterRecipe : FormSubContentBase
    {
        ...
        public FormVisionParameterRecipe(Vision vision)
            : base(FormType.Content.ToString(), vision.Name)
        {
            InitializeComponent();
            m_Owner = vision;
