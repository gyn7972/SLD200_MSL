...
namespace CWA150SA_Onsemi300
{
    ...
    public partial class ModuleButton : UserControl
    {
        ...
        public ModuleButton(Module module)
        {
            ...
            {
                this.buttonModule.BackgroundImage = CWA150SA_Onsemi.Properties.Resources.TargetStage_Exist;
            }
            else if (buttonModule.Name == "SourceStage")
            {
                this.buttonModule.BackgroundImage = CWA150SA_Onsemi.Properties.Resources.SourceStage_Exist;
            }
            else if(buttonModule.Name == "DieTransfer")
            {
                this.buttonModule.BackgroundImage = CWA150SA_Onsemi.Properties.Resources.DieTransfer_NonWorking;
            }
            else
            {
