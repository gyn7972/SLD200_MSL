...
{
    public partial class FormOperationSingleMode : FormSubContentBase
    {
        public FormOperationSingleMode()
            :base(FormType.withButton.ToString(),"Single Mode")
        {
            InitializeComponent();

            SingleMode_CWA150SA singleMode_CWA150SA = new SingleMode_CWA150SA();
            ...
            //singleMode_CWA150SA.Location = new Point(5, 30);
            //this.panelContent.Controls.Add(singleMode_CWA150SA);
        }
    }
}
