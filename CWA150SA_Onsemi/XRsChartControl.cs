...
namespace CWA150SA_Onsemi300
{
    ...
    public partial class XRsChartControl : UserControl
    {
        ...
        public void SetRsRange(double min, double max)
        {
            this.baseTextBoxRangeRsMin.Text = min.ToString();
            this.baseTextBoxRangeRsMax.Text = max.ToString();
        }

        public RangeD GetRsRange()
        {
            double minimum = double.Parse(this.baseTextBoxRangeRsMin.Text);
            double maximum = double.Parse(this.baseTextBoxRangeRsMax.Text);
