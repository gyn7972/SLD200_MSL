...
namespace QMC.Common.Parts
{
    public class XyzStage : XyStage
    {
        ...
        #region Constructor
        public XyzStage(string strName) : base(strName)
        {
            this.CenterCoordinate = new XyzCoordinate(0, 0, 0);
        }
        #endregion

        #region Property
        public XyzCoordinate CenterCoordinate { get; set; }
        #endregion
