...
{
    public class ZzxzxyStage : XyStage
    {
        #region Define
        [Serializable]
        ...
        #region Constructor
        public ZzxzxyStage(string strName) : base(strName)
        {
            this.CenterCoordinate = new ZzxzxyCoordinate(0, 0, 0, 0, 0, 0);
        }
        #endregion

        #region Property
        public ZzxzxyCoordinate CenterCoordinate { get; set; }
        public Camera Camera { get; set; }
        public ZzxzxyStageConfig Config { get; set; }
        ...
        public override int Initialize()
        {
            ...
            Task<int> task = Task.Factory.StartNew(() =>
            {
                ...
                if ((ret = Axes[MotionKey.ALN_X.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.ALN_Y.ToString()].Initialize()) != 0) return ret;
        ...
        #region Method
        public int MovePosition(ZzxzxyCoordinate coordinate)
        {
            ...
            dicMovingProjection[MotionKey.ALN_X.ToString()].Position = coordinate.ALN_X;
            dicMovingProjection[MotionKey.ALN_Y.ToString()].Position = coordinate.ALN_Y;
        ...
        public Task<int> BeginMovePosition(ZzxzxyCoordinate coordinate)
        {
            Dictionary<string, MovingProjection> dicMovingProjection = GetDefaultMovingProjections();
        ...
        public int GetCommandPosition(ref ZzxzxyCoordinate currentPosition)
        {
            int ret = 0;

            if (currentPosition == null)
                currentPosition = new ZzxzxyCoordinate();
            ...
            m_dicAxes[MotionKey.ALN_X.ToString()].GetCommandPosition(ref dPos);
            currentPosition.ALN_X = dPos;
            m_dicAxes[MotionKey.ALN_Y.ToString()].GetCommandPosition(ref dPos);
            currentPosition.ALN_Y = dPos;
        ...
        public int GetActualPosition(ref ZzxzxyCoordinate currentPosition)
        {
            int ret = 0;
            ...
            currentPosition.TR_Z = dPos;
            m_dicAxes[MotionKey.ALN_X.ToString()].GetActualPosition(ref dPos);
            currentPosition.ALN_X = dPos;
            m_dicAxes[MotionKey.ALN_Y.ToString()].GetActualPosition(ref dPos);
            currentPosition.ALN_Y = dPos;
