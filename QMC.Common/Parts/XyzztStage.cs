...
{
    public class XyzztStage : XyStage
    {
        #region Define
        [Serializable]
        ...
        #region Constructor
        public XyzztStage(string strName) : base(strName)
        {
            this.CenterCoordinate = new XyzztCoordinate(0, 0, 0, 0, 0);
        }
        #endregion

        #region Property
        public XyzztCoordinate CenterCoordinate { get; set; }
        public Camera Camera { get; set; }
        public XyzztStageConfig Config { get; set; }
        ...
        public override int Create()
        {
            ...
            m_dicAxisDisplayType.Add(MotionKey.IZ.ToString(), DisplayAxisType.Vertical);
            m_dicAxisDisplayType.Add(MotionKey.SZ.ToString(), DisplayAxisType.Vertical);
        ...
        public override int Initialize()
        {
            ...
            Axes[MotionKey.IZ.ToString()].Initialize();
            Axes[MotionKey.SZ.ToString()].Initialize();

            Task<int> task = Task.Factory.StartNew(() =>
            {
                if ((ret = Axes[MotionKey.T.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.IZ.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.SZ.ToString()].Initialize()) != 0) return ret;
        ...
        #region Method
        public int MovePosition(XyzztCoordinate coordinate)
        {
            ...
            dicMovingProjection[MotionKey.IZ.ToString()].Position = coordinate.IZ;
            dicMovingProjection[MotionKey.SZ.ToString()].Position = coordinate.SZ;
        ...
        public Task<int> BeginMovePosition(XyzztCoordinate coordinate)
        {
            Dictionary<string, MovingProjection> dicMovingProjection = GetDefaultMovingProjections();
        ...
        public int GetCommandPosition(ref XyzztCoordinate currentPosition)
        {
            int ret = 0;

            if (currentPosition == null)
                currentPosition = new XyzztCoordinate();
            ...
            currentPosition.IZ = dPos;
            m_dicAxes[MotionKey.SZ.ToString()].GetCommandPosition(ref dPos);
            currentPosition.SZ = dPos;
        ...
        public int GetActualPosition(ref XyzztCoordinate currentPosition)
        {
            int ret = 0;
            ...
            currentPosition.IZ = dPos;
            m_dicAxes[MotionKey.SZ.ToString()].GetActualPosition(ref dPos);
            currentPosition.SZ = dPos;
