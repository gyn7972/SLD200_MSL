...
namespace QMC.Common.Parts
{
    public class YStage : XyStage
    {
        ...
        #region Constructor
        public YStage(string strName) : base(strName)
        {
            this.CenterCoordinate = new YCoordinate(0);
        }
        #endregion

        #region Property
        public YCoordinate CenterCoordinate { get; set; }
        public Camera Camera { get; set; }
        public YStageConfig Config { get; set; }
        ...
        public int MovePosition(YCoordinate coordinate)
        {
            Dictionary<string, MovingProjection> dicMovingProjection = GetDefaultMovingProjections();
        ...
        public Task<int> BeginMovePosition(YCoordinate coordinate)
        {
            Dictionary<string, MovingProjection> dicMovingProjection = GetDefaultMovingProjections();
        ...
        public int GetCommandPosition(ref YCoordinate currentPosition)
        {
            int ret = 0;

            if (currentPosition == null)
                currentPosition = new YCoordinate();
        ...
        public int GetActualPosition(ref YCoordinate currentPosition)
        {
            int ret = 0;
