...
{
    public class UvwzxyzStage : XyStage
    {
        #region Define
        ...
        #region Constructor
        public UvwzxyzStage(string strName) : base(strName)
        {
            this.CenterCoordinate = new UvwzxyzCoordinate(0, 0, 0, 0, 0, 0, 0);
        }
        #endregion

        #region Property
        public UvwzxyzCoordinate CenterCoordinate { get; set; }
        public Camera Camera { get; set; }
        public UvwzxyzStageConfig Config { get; set; }
        ...
        public override int Initialize()
        {
            ...
            Axes[MotionKey.EZ.ToString()].Initialize();
            Axes[MotionKey.VZ.ToString()].Initialize();

            Task<int> task = Task.Factory.StartNew(() =>
            {
                if ((ret = Axes[MotionKey.U.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.V.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.W.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.EZ.ToString()].Initialize()) != 0) return ret;
                if ((ret = Axes[MotionKey.VZ.ToString()].Initialize()) != 0) return ret;
        ...
        #region Method
        public int MovePosition(UvwzxyzCoordinate coordinate)
        {
            ...
            dicMovingProjection[MotionKey.EZ.ToString()].Position = coordinate.EZ;
            ...
            dicMovingProjection[MotionKey.VZ.ToString()].Position = coordinate.VZ;
        ...
        public Task<int> BeginMovePosition(UvwzxyzCoordinate coordinate)
        {
            Dictionary<string, MovingProjection> dicMovingProjection = GetDefaultMovingProjections();
        ...
        public int GetCommandPosition(ref UvwzxyzCoordinate currentPosition)
        {
            int ret = 0;

            if (currentPosition == null)
                currentPosition = new UvwzxyzCoordinate();

            double dPos = 0;
            m_dicAxes[MotionKey.U.ToString()].GetCommandPosition(ref dPos);
            currentPosition.U = dPos;
            m_dicAxes[MotionKey.V.ToString()].GetCommandPosition(ref dPos);
            currentPosition.V = dPos;
            m_dicAxes[MotionKey.W.ToString()].GetCommandPosition(ref dPos);
            currentPosition.W = dPos;
            m_dicAxes[MotionKey.EZ.ToString()].GetCommandPosition(ref dPos);
            currentPosition.EZ = dPos;
            ...
            m_dicAxes[MotionKey.VZ.ToString()].GetCommandPosition(ref dPos);
            currentPosition.VZ = dPos;
            return ret;
        }
        ...
        public int GetActualPosition(ref UvwzxyzCoordinate currentPosition)
        {
            int ret = 0;
            ...
            m_dicAxes[MotionKey.U.ToString()].GetActualPosition(ref dPos);
            currentPosition.U = dPos;
            m_dicAxes[MotionKey.V.ToString()].GetActualPosition(ref dPos);
            currentPosition.V = dPos;
            m_dicAxes[MotionKey.W.ToString()].GetActualPosition(ref dPos);
            currentPosition.W = dPos;
            m_dicAxes[MotionKey.EZ.ToString()].GetActualPosition(ref dPos);
            currentPosition.EZ = dPos;
            m_dicAxes[MotionKey.X.ToString()].GetActualPosition(ref dPos);
            currentPosition.X = dPos;
            m_dicAxes[MotionKey.Y.ToString()].GetActualPosition(ref dPos);
            currentPosition.Y = dPos;
            m_dicAxes[MotionKey.VZ.ToString()].GetActualPosition(ref dPos);
            currentPosition.VZ = dPos;
