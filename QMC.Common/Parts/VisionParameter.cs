...
{
    public class VisionParameter : MotionPart
    {
        #region Enum List
...
//#if false                                                               //  SLD-200U
        ...
        public VisionParameterConfig Config { get; set; }
        public VisionParameterRecipe Recipe { get; set; }

        public stVisionParam stVisionPosParam;
        public stVisionParam stVisionPosParam2;
        public stVisionParam stVisionPosParam_Verify;             //  위치 좌표 무결성 검사
        public stVisionParam stStageLoadPosParam;
        public stVisionParam stStageCenterPosParam;
        public stVisionParam stHighVisionCenterPosParam;
        public stVisionParam stLowVisionCenterPosParam;


        public VisionParameter(string strName) : base(strName)
        {
            Config = new VisionParameterConfig();
            Recipe = new VisionParameterRecipe();
        }
        ...
        public stVisionParam GetPositionInformation(string m_strPosName)
        {
            stVisionParam m_stLaserPosParam = new stVisionParam();
