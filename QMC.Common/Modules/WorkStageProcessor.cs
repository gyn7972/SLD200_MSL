...
namespace QMC.Process.WorkStage.Modules
{
    ...
    public class WorkStageProcessor : Module
    {
        ...
        public WorkStageProcessorConfig Config { set; get; }
        public WorkStageProcessorRecipe Recipe { set; get; }
        ...
        public WorkStageProcessor(string strName) : base(strName)
        {
            Config = new WorkStageProcessorConfig();     
        ...
        public override int Create()
        {
            ...
            Recipe = new WorkStageProcessorRecipe(this);
        ...
        {
            Config = parameter as WorkStageProcessorConfig;
            if(Config == null)
                Config = new WorkStageProcessorConfig();
            Config.Init();
        ...
        {
            Recipe = recipeData as WorkStageProcessorRecipe;
            if (Recipe == null)
                Recipe = new WorkStageProcessorRecipe(this);
            Recipe.Init(this);
        ...
        public int PrepareToLoad()
        {
            ...
            XyztCoordinate xyzCoordinate = Config.GetPositionData(WorkStageProcessorConfig.PositionKey.Load.ToString());
        ...
        public int PrepareToUnload()
        {
            ...
            XyztCoordinate xyztCoordinate = Config.GetPositionData(WorkStageProcessorConfig.PositionKey.Unload.ToString());
        ...
        public int PrepareToEtchingProcess()
        {
            ...
            XyztCoordinate xyztCoordinate = Config.GetPositionData(WorkStageProcessorConfig.PositionKey.Etching.ToString());
...
/*            if (Carrier == null)
        ...
        public int RunEtchingProcess()
        {
            ...
            XyztCoordinate coordinate = Config.GetPositionData(WorkStageProcessorConfig.PositionKey.Etching.ToString());
