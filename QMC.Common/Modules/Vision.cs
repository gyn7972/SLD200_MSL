...
namespace QMC.Common.Modules
{
        ...
        : Module
    {
        ...
        #region Property
        public VisionConfig Config { set; get; }
        public VisionParameterConfig ParamConfig { set; get; }
        public VisionRecipe Recipe { set; get; }
        ...
        public VisionParameter visionParameter { set; get; }
        ...
        public enum Vision_TeachingPosList : int
        {
            Vision_FocusPos,
            Laser_FocusPos,          
            ...
            Laser_Sensor_HeightCheck_StagePos
        }
        ...
        #region Constructor
        public Vision(string strName) : base(strName)
        {
        ...
        {
            Config = configData as VisionConfig;
            ...
            if (Config.ParamConfig != null)
            {
                ...
                visionParameter.Config = ParamConfig;
            }
        ...
        {
            VisionRecipe recipe = recipeData as VisionRecipe;
            if (recipe == null)
            {
                recipe = new VisionRecipe(this);
            }
        ...
        public bool Teaching_Position_Load()
        {
            ...
            for (int i = 0; i < System.Enum.GetValues(typeof(Vision_TeachingPosList)).Length; i++)
            {
                ...
                stVisionTeachingPos[i].Vision_Z = Equipment.ToDouble(temp.ToString());
            }
        ...
        public bool Move_Properties_Load()
        {
            ...
            for (int i = 0; i < System.Enum.GetValues(typeof(Vision_TeachingPosList)).Length; i++)
            {
                ...
                stVisionPosMoveProperties[i].Fine_Accel = Equipment.ToInt(temp.ToString());
                //  Fine Settle Delay
                NativeMethods.GetPrivateProfileString(strTemp, "Fine_SettleDelay", "200", temp, 255, strFIle);
                stVisionPosMoveProperties[i].Fine_SettleDelay = Equipment.ToInt(temp.ToString());
                //  Coarse Accel
                NativeMethods.GetPrivateProfileString(strTemp, "Coarse_Accel", "200", temp, 255, strFIle);
                stVisionPosMoveProperties[i].Coarse_Accel = Equipment.ToInt(temp.ToString());
                //  Coarse Settle Delay
                NativeMethods.GetPrivateProfileString(strTemp, "Coarse_SettleDelay", "20", temp, 255, strFIle);
                stVisionPosMoveProperties[i].Coarse_SettleDelay = Equipment.ToInt(temp.ToString());
            }
        ...
        public stCameraParam Machine_Parameter_Camera_Setting_Load()
        {
            ...
            //    stCameraSet.Lower_Width = Equipment.ToInt(temp.ToString());

            //    //  Wafer 카메라 Height
            //    NativeMethods.GetPrivateProfileString("Lower_Camera", "Height", "1880", temp, 255, strFile);
            //    stCameraSet.Lower_Height = Equipment.ToInt(temp.ToString());
