...
namespace QMC.Common.Modules
{
    ...
    {
        #region Laser Error Codes
        //  Diamond J-5V-HD Series (CO₂레이져 에러 코드)
        public const byte laserErrCode_NoFault = 0;                         //  No Faults Detected - Reset Faults State

        //  이하 Node Faults
        public const byte laserErrCode_ShutterInterlock = 2;                //  Shutter Interlock Open
        public const byte laserErrCode_ShutterTransition = 3;               //  Shutter Transition Failure
        public const byte laserErrCode_NodeTemperatureFault = 4;            //  Node Temperature Shutdown
        public const byte laserErrCode_DewPointFault = 5;                   //  Dew Point insdequate for operation
        public const byte laserErrCode_DriverVoltageStartupFault = 6;       //  Driver Voltage failed Startup test
        public const byte laserErrCode_48VPowerSupply = 7;                  //  +48V DCPS Out of Range
        public const byte laserErrCode_5VPowerSupply = 8;                   //  +5V DCPS Out of Range
        public const byte laserErrCode_I2CCommunication = 9;                //  I2C Communication Failure
        public const byte laserErrCode_MicrocomputerEEPROM = 10;            //  Microcomputer EEPROM Failure
        public const byte laserErrCode_MicrocomputerRAM = 11;               //  Microcomputer RAM Failure
        public const byte laserErrCode_MicrocomputerMemory = 12;            //  Microcomputer Program Memory Checksum Failure
        public const byte laserErrCode_MicrocomputerADC = 13;               //  Microcomputer ADC Failure
        public const byte laserErrCode_48VSupplyCurrent = 15;               //  +48V Supply Current Fault
        public const byte laserErrCode_ControlFault = 16;                   //  Control Mismatch Condition
        public const byte laserErrCode_SimmerFault = 17;                    //  Laser discharge not detected
        public const byte laserErrCode_NodeTemperatureWarning = 20;         //  Node Temperature Out of Range
        public const byte laserErrCode_SPICommunication = 21;               //  SPI Communication Failure
        public const byte laserErrCode_3p3VPowerSupply = 22;                //  +3.3V DCPS Out of Range
        public const byte laserErrCode_DriverVoltageWarning = 23;           //  Driver Voltage Out of Range
        public const byte laserErrCode_ParameterizationFault = 24;          //  CPLD failed to acknowledge parameterization data
        public const byte laserErrCode_DriverVoltageFault = 25;             //  Incorrect driver voltage setpoint
        public const byte laserErrCode_DefaultControllerDatabase = 96;      //  Using default due to I2C error
        public const byte laserErrCode_NewDatabaseAccepted = 97;            //  Database Post Completed
        public const byte laserErrCode_DatabaseNeedsInit = 98;              //  Database Post Required
        public const byte laserErrCode_DatabaseConfigurationFault = 112;    //  Operating Parameter Mismatch
        public const byte laserErrCode_NodeResetCompleted = 137;            //  Node has reset
        public const byte laserErrCode_CommandACK = 170;                    //  Acknowledgement of Command

        //  이하 Reflash Command Responses
        public const byte laserErrCode_ReflashImageCRCFail = 171;           //  CRC of Image Space Failed
        public const byte laserErrCode_ReflashApplicationCRCFail = 172;     //  CRC of Application Space Failed
        public const byte laserErrCode_ReflashStuckInBootloader = 173;      //  Node EIA485 did not leave boot code space
        ...
        public const byte laserCmdCode_NodeReset = 1;                       //  Request POR from node
        public const byte laserCmdCode_ClearFault = 2;                      //  Clear reported fault
        public const byte laserCmdCode_RemoteRFEnable = 3;                  //  Allow modulation
        public const byte laserCmdCode_RemoteRFDisable = 4;                 //  Block modulation
        public const byte laserCmdCode_ShortStatusRequest = 18;             //  Get boolean diagnostic data
        public const byte laserCmdCode_TurnOffOscDrvDC = 19;                //  Block +48V to driver
        public const byte laserCmdCode_TurnOnOscDrvDC = 20;                 //  Replace +48V to driver
        public const byte laserCmdCode_ChecksumGet = 21;                    //  Software checksum request
        public const byte laserCmdCode_DatabaseGet = 32;                    //  Parameter get request
        public const byte laserCmdCode_DatabaseSet = 33;                    //  Parameter set request
        public const byte laserCmdCode_TimeSet = 34;                        //  Store Operating Time
        public const byte laserCmdCode_TimeGet = 35;                        //  Get Operating Time
        public const byte laserCmdCode_RetestPassFET = 38;                  //  Request retest after boot
        #endregion
        ...
        #region Property
        public LaserConfig Config { set; get; }
        public LaserParameterConfig ParamConfig { set; get; }
        public LaserRecipe Recipe { set; get; }                
        ...
        public LaserParameter laserParameter { set; get; }
        #endregion
        ...
        #region Constructor
        public Laser(string strName) : base(strName)
        {
            bool ret = true;

            ParamConfig = new LaserParameterConfig();
            Config = new LaserConfig();
        ...
        public override int Create()
        {
            ...
            laserParameter = new LaserParameter("Laser Parameter");
            laserParameter.Create();
            laserParameter.Owner = this;
            laserParameter.Axes = Stage.Axes;
            Parts.Add(laserParameter);

            //PosParam_Dispenser = GetConfigData();     //  요건 나중에

            Recipe = new LaserRecipe(this);
        ...
        {
            Config = configData as LaserConfig;
            ...
            if (Config.ParamConfig != null)
            {
                ...
                laserParameter.Config = ParamConfig;
            }
        ...
        {
            LaserRecipe recipe = recipeData as LaserRecipe;
            if (recipe == null)
            {
                recipe = new LaserRecipe(this);
            }
