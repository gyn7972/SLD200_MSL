...
namespace QMC.Common.Modules
{
    ...
    public class Scanner : Module
    {
        ...
        public ScannerParameterConfig ParamConfig { set; get; }
        ...
        public ScannerParameter scannerParameter { set; get; }
        #endregion
        ...
        public Scanner(string strName) : base(strName)
        {
            ...
            ParamConfig = new ScannerParameterConfig();
        ...
        public override int Create()
        {
            ...
            scannerParameter = new ScannerParameter("Scanner Parameter");
            scannerParameter.Create();
            scannerParameter.Owner = this;
            scannerParameter.Axes = Stage.Axes;
            Parts.Add(scannerParameter);

            //PosParam_Dispenser = GetConfigData();     //  요건 나중에

            Recipe = new ScannerRecipe(this);
        ...
        {
            Config = configData as ScannerConfig;
            ...
            if (Config.ParamConfig != null)
            {
                ...
                scannerParameter.Config = ParamConfig;
            }
        ...
        {
            ScannerRecipe recipe = recipeData as ScannerRecipe;
            if (recipe == null)
            {
                recipe = new ScannerRecipe(this);
            }
