...
namespace QMC.Common
{
    ...
    public sealed class FileHelper
    {
        ...
        ///// <summary>
        ///// 콘솔 프로그램 동작시 마우스 편집 모드 비활성화 하기
        ///// </summary>
        ///// <param name="consoleHandle"></param>
        ///// <returns></returns>
        //public static bool DisableConsoleEdit(IntPtr consoleHandle)
        //{
        //    if (!NativeMethods.GetConsoleMode(consoleHandle, out uint consoleMode))
        //        return false;
        //    consoleMode &= ~(uint)NativeMethods.ConsoleModes.ENABLE_QUICK_EDIT_MODE;
